...
5. You can access BigQuery by using the (Console)[https://cloud.google.com/bigquery/docs/quickstarts/query-public-dataset-console], **Web UI** or a **command-line tool** using a variety of client libraries such as Java, .NET, or Python.
6. There are also a variety of solution providers that you can use to interact with BigQuery.
...
student-04-cca41f438c2d@qwiklabs.net
Copied!
...
When you are connected, you are already authenticated, and the project is set to your Project_ID, qwiklabs-gcp-00-bf1c9480f6a7. The output contains a line that declares the Project_ID for this session:

Your Cloud Platform project in this session is set to qwiklabs-gcp-00-bf1c9480f6a7
...
ACTIVE: *
ACCOUNT: student-04-cca41f438c2d@qwiklabs.net
...
[core]
project = qwiklabs-gcp-00-bf1c9480f6a7
